...
<head>
  ...
  <title>SIMALPRO <?php echo $lokasi;?> | Project Transport</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url().'admin/transport/link2'?>" class="btn btn-success btn-flat pull-left"><span class="fa fa-arrow-left"></span> Kembali</a>
        ...
        <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/transport/simpan_project'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                     <input type="hidden" name="link" value="<?php echo $link;?>"/> 
                     <input type="hidden" name="project" value="<?php echo $project;?>"/> 
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor Core</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="no_core" class="form-control" id="inputUserName" placeholder="Nomor Core">
                                        </div>
                                    </div>
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Service</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="service" class="form-control" id="inputUserName" placeholder="Service">
                                        </div>
                                    </div>
                                  <div class="form-group">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $no_urut;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/transport/update_project'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                     ...
                     <input type="hidden" name="project" value="<?php echo $project;?>"/> 
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nomor Core</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="no_core" class="form-control" id="inputUserName" placeholder="Nomor Core" value="<?php echo $no_core; ?>">
                                        </div>
                                    </div>
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Service</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="service" class="form-control" id="inputUserName" placeholder="Service" value="<?php echo $service; ?>">
                                        </div>
                                    </div>
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Keterangan</label>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $no_urut;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/transport/hapus_project'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                     <input type="hidden" name="kode" value="<?php echo $no_urut;?>"/> 
                            <p>Apakah Anda yakin mau menghapus no. Core <b><?php echo $no_core;?></b> ?</p>
