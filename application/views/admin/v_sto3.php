...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="">
            <div class="box-header">
              <form action="<?php echo base_url().'admin/transport/add_history_core/'.$idcores?>" method="post" enctype="multipart/form-data">
                <button class="btn btn-success btn-flat" value="<?php echo $idcores;?>" name="link"><span class="fa fa-plus"></span> Add STO</button>
              </form>
            <?php echo $this->session->flashdata('notif') ?>
            <form method="POST" action="<?php echo base_url() ?>admin/sto/upload" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $idsto;?></td>
                  <td><?php echo $nama_sto;?></td>
                  <td><?php echo $kode_sto;?></td>                  
                  <!--<td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $idhistory;?>"><span class="fa fa-pencil"></span></a>
                        <?php if($this->session->userdata('level')==1) :?><a class="btn" data-toggle="modal" data-target="#ModalHapusHist<?php echo $idhistory;?>"><span class="fa fa-trash"></span></a><?php endif; ?>
                  </td>-->
                </tr>
				<?php endforeach;?>
                </tbody>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 Network Area Witel Surabaya Selatan.</strong> All rights reserved.
  </footer>
...
<!-- ./wrapper -->
  ...
  <?php foreach ($data->result_array() as $i) :
                       $idhistory=$i['idhistory'];
           ?>
  <!--Modal Hapus Link-->
        <div class="modal fade" id="ModalHapusHist<?php echo $idhistory;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Core</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/transport/hapus_history'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                     <input type="hidden" name="idcores" value="<?php echo $idcores;?>"/>
                     <input type="hidden" name="idkabel" value="<?php echo $no_urut;?>"/> 
                            <p>Apakah Anda yakin mau menghapus data core ini?</p>
