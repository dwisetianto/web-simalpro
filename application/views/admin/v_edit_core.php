...
<head>
  ...
  <title>SIMALPRO | Edit Core Transport</title>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Edit Core <?php echo $link;?> Kabel <?php echo $merk;?></h3>
            </div>
            <div class="box-body">
              <form action="<?php echo base_url().'admin/transport/update_core'?>" method="post" enctype="multipart/form-data">
                <?php if (!$link) : ?>
              ...
              <?php
                ...
                foreach ($sto->result_array() as $i) :
                  $lok=$i['link'];
                  ?>
                      <option value="<?php echo $idlink;?>"><?php echo $lok;?></option>
              <?php endforeach;?>
                    </select>
                  </div>
                <?php else: ?>
                  <div class="form-group">
                    <label for="metro">ID Link</label>
                    <input type="text" class="form-control" name="idlink" placeholder="Link" value="<?php echo $idlink; ?>" readonly>
                  </div>
                <?php endif; ?>
                <div class="form-group">
                                        <label for="witel">Witel</label>
                                        <div>
                                            <select class="form-control select2" name="witel" style="width: 100%;" disabled='true' required>
                                            <option value="">Pilih Witel</option>
                                    <?php
                                      $wit=$this->db->query("SELECT * FROM tbl_witel where idwitel=".$witelid);
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="merk" placeholder="Merk" value="<?php echo $merk; ?>" readonly>
                                <input type="hidden" class="form-control" name="idkabel" value="<?php echo $idkabel; ?>">
                                <input type="hidden" class="form-control" name="idcores" value="<?php echo $idcores; ?>">
                                <input type="hidden" class="form-control" name="idwitel" value="<?php echo $witelid; ?>">
                      </div>
                      <div class="col-xs-6">
                                <label for="link">No Core</label>
                                <input type="number" class="form-control" name="nocore" value="<?php echo $idcore; ?>" placeholder="Nomor core" required>
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <label for="alamat">User</label>
                  <input type="text" class="form-control" name="user" value="<?php echo $user; ?>" placeholder="Nama User">
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-4">
                                <label for="link">Service Name</label>
                                <input type="text" class="form-control" name="service" value="<?php echo $service_name; ?>" placeholder="Nama Service" required>
                      </div>
                      <div class="col-xs-4">
                                <label for="core">Port Service</label>
                                <input type="text" class="form-control" name="port" value="<?php echo $port_service; ?>" placeholder="Port Service">
                      </div>
                      <div class="col-xs-4">
                                <label for="core">Status</label>
                                <select class="form-control select2" name="status" style="width: 100%;" required>
                                  <option value="">Pilih Status</option>
                                  <option value="op" <?php if ($status=="op") echo "selected"; ?>>Operasi</option>
              ...
              <form action="<?php echo base_url().'admin/transport/edit_link/'.$idkabel?>" method="post" enctype="multipart/form-data">
