...
<head>
  ...
  <title>SIMALPRO | Edit Transport Link</title>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Edit Transport Link</h3>
            </div>
            <div class="box-body">
              <?php //print_r($no_urut);die; ?>
              <form action="<?php echo base_url().'admin/transport/update_osp_pakai'?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php $j=0;
                                ...
                                foreach ($x->result_array() as $i){ ?>
                                  <div class="form-group">
                                        ...
                                        <label for="inputUserName" class="col-sm-2 control-label">Core <?php echo $j+1;?></label>
                                        <div class="col-sm-4">
