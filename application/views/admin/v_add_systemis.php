...
<head>
  ...
  <title>SIMALPRO | Add Katalis</title>
  ...
  <aside class="main-sidebar">
    ...
    <?php if (!$lokasi) : ?>
      <section class="sidebar">
        ...
        <li class="active">
          <a href="<?php echo base_url().'admin/systemis'?>">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Katalis</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
    <form action="<?php echo base_url().'admin/systemis/simpan_systemis'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Katalis</h3>
            </div>
            <div class="box-body">
