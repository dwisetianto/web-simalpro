              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <?php endif; ?>
                  ...
                  <td style="text-align:right;">
                    <form action="<?php echo base_url().'admin/transport/dwdm_isp'?>" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="lokasi" value="<?php echo $lokasi2; ?>">
                      <button value="<?php echo $dwdm;?>" name="dwdm">Lihat</button>
                    </form>
                  </td>
                </tr>
				<?php endforeach;?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="dwdm" class="form-control" id="inputUserName" placeholder="DWDM">
                                        </div>
                                    </div>
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jenis</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="jenis" class="form-control" id="inputUserName" placeholder="Jenis">
                                        </div>
                                    </div>
                                  <div class="form-group">
