        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <?php if ($this->session->userdata('level')==1) : ?><a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-user-plus"></span> Add Pengguna</a><?php endif; ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <th>Email</th>
                    <th>Jenis Kelamin</th>
                    <?php if($this->session->userdata('level')==1) :?><th>Password</th><?php endif; ?>
                    <th>Kontak</th>
                    <th>Level</th>
                ...
                <tr>
                  ...
                  <?php else:?>
                        <td>Perempuan</td>
                  <?php endif;?>
                  <?php if($this->session->userdata('level')==1) :?><td><?php echo $pengguna_password;?></td><?php endif; ?>
                  ...
                  <td style="text-align:right;">
                        ...
                        <?php if($this->session->userdata('level')==1) :?><a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $pengguna_id;?>"><span class="fa fa-trash"></span></a><?php endif; ?>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputWitel" class="col-sm-4 control-label">Witel</label>
                                        <div class="col-sm-7">
                                            <select type="text" name="xwitel" class="form-control" id="inputWitel" placeholder="Nama Witel" required>
