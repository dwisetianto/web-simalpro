...
<head>
  ...
  <title>Switching | Add Battery</title>
...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?php echo base_url().'admin/cme/batt'?>"><i class="fa fa-battery-3"></i> Perangkat Baterai</a></li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/cme/batt/view'?>"><i class="fa fa-battery-3"></i> Perangkat Baterai</a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/batt/simpan_batt'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat Baterai</h3>
            </div>
            <div class="box-body">
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_batt");
                foreach ($sto->result_array() as $i) :
