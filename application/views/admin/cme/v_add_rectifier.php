...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?php echo base_url().'admin/cme/rectifier'?>"><i class="fa fa-arrows-alt"></i> Perangkat Rectifier</a></li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/cme/rectifier/view'?>"><i class="fa fa-arrows-alt"></i> Perangkat Rectifier</a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/rectifier/simpan_rectifier'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat Rectifier</h3>
            </div>
            <div class="box-body">
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_rectifier");
                foreach ($sto->result_array() as $i) :
