...
<head>
  ...
  <title>SIMALPRO | Add Inverter</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/invups/simpan_invups'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat Inverter</h3>
            </div>
            <div class="box-body">
                <div class="form-group">
                  <label for="metro">Area/Catel</label>
                  <input type="text" class="form-control" name="area" placeholder="Area/Catel">
                </div>
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_invups");
                foreach ($sto->result_array() as $i) :
