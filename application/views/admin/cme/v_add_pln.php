...
<head>
  ...
  <title>SIMALPRO | Add PLN Devices</title>
...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?php echo base_url().'admin/cme/pln'?>"><i class="fa fa-bolt"></i> Perangkat PLN</a></li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/cme/pln/view'?>"><i class="fa fa-bolt"></i> Perangkat PLN</a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/pln/simpan_pln'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat PLN</h3>
            </div>
            <div class="box-body">
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_pln");
                foreach ($sto->result_array() as $i) :
