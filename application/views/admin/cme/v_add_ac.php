...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url().'admin/cme/ac'?>"><i class="fa fa-keyboard-o"></i> Perangkat AC</a></li>
    ...
    <?php else: ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/cme/ac/view'?>"><i class="fa fa-keyboard-o"></i> Perangkat AC</a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/ac/simpan_ac'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat AC</h3>
            </div>
            <div class="box-body">
              ...
              <?php endforeach;?>
                ...
                <div class="form-group">
                  <label>Nama Perangkat</label>
                    <select class="form-control select2-tags" name="nama" style="width: 100%;" required>
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_ac");
                foreach ($sto->result_array() as $i) :
                  $lok=$i['nama_perangkat'];
                  ?>
                      <option value="<?php echo $lok;?>"><?php echo $lok;?></option>
              <?php endforeach;?>
                    </select>
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-6">
                                <label for="core">Merk Perangkat</label>
                                <input type="text" class="form-control" name="merk" placeholder="Merk Perangkat">
                      </div>
                      <div class="col-xs-3">
                                <label for="link">Type Perangkat</label>
                                <input type="text" class="form-control" name="tipe" placeholder="Type Perangkat">
                      </div>
                      <div class="col-xs-3">
                                <label for="core">Nomor Seri</label>
                                <input type="text" class="form-control" name="nomor" placeholder="Nomor Seri">
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-6">
                                <label for="link">Kapasitas TPS</label>
                                <input type="text" class="form-control" name="tps" placeholder="Kapasitas TPS">
                      </div>
                      <div class="col-xs-6">
                                <label for="core">Kapasitas TPK</label>
                                <input type="text" class="form-control" name="tpk" placeholder="Kapasitas TPK">
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-4">
                                <label for="core">Satuan</label>
                                <input type="text" class="form-control" name="satuan" placeholder="Satuan">
                      </div>
                      <div class="col-xs-4">
                                <label for="link">Jumlah</label>
                                <input type="text" class="form-control" name="jumlah" placeholder="Jumlah">
                      </div>
                      <div class="col-xs-4">
                                <label for="core">Tahun Operasional</label>
                                <input type="text" class="form-control" name="operasional" placeholder="Tahun Operasional">
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-xs-8">
                                <label for="core">Ruangan</label>
                                <input type="text" class="form-control" name="fungsi" placeholder="Ruangan">
                      </div>
                  </div>
                </div>
                ...
                <!--<div class="form-group">
                  <label for="alamat">Witel</label>
                  <input type="text" class="form-control" name="witel" placeholder="Keterangan" value="<?php echo $wit; ?>">
                </div>-->
