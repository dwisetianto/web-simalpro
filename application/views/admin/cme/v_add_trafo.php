...
<head>
  ...
  <title>SIMALPRO | Add Trafo</title>
...
<div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?php echo base_url().'admin/cme/trafo'?>"><i class="fa fa-archive"></i> Perangkat Trafo</a></li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/cme/trafo/view'?>"><i class="fa fa-archive"></i> Perangkat Trafo</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/cme/trafo/simpan_trafo'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">

          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Perangkat Trafo</h3>
            </div>
            <div class="box-body">
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT nama_perangkat FROM cme_trafo");
                foreach ($sto->result_array() as $i) :
