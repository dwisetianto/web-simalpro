...
<head>
  ...
  <title>SIMALPRO | Add Perangkat Metro</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="<?php echo base_url().'admin/metro/simpan_metro'?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <?php
                $sto=$this->db->query("SELECT DISTINCT lokasi FROM tbl_metro");
              ...
              <?php endforeach;?>
                ...
                <?php endif; ?>
                <div class="form-group">
                  <label for="metro">Kelompok</label>
                    <select class="form-control select2-tags" name="kelompok" style="width: 100%;" required>
                      <option value="">Pilih Kelompok Metro</option>
              <?php
                $sto=$this->db->query("SELECT DISTINCT kelompok FROM tbl_metro");
                foreach ($sto->result_array() as $i) :
                  $kel=$i['kelompok'];
                  ?>
              ...
              <?php endforeach;?>
                ...
                <div class="form-group">
                  <label for="metro">Nama Network</label>
                  <input type="text" class="form-control" name="nama_ne" placeholder="Nama Network">
                </div>
                <div class="form-group">
                  <label for="metro">IP Address</label>
                  <input type="text" class="form-control" name="ip_adress" placeholder="IP Address">
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-4">
