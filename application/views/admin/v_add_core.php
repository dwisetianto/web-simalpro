        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Tambah Core <?php echo $link;?> Kabel <?php echo $merk;?></h3>
            </div>
            <div class="box-body">
              <form action="<?php echo base_url().'admin/transport/simpan_core'?>" method="post" enctype="multipart/form-data">
                <?php if (!$link) : ?>
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-xs-6">
                                ...
                                <input type="number" class="form-control" name="nocore" placeholder="Nomor core" required>
                      </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-xs-4">
                                ...
                                <input type="text" class="form-control" name="service" placeholder="Nama Service" required>
                      </div>
                      <div class="col-xs-4">
                                <label for="core">Port Service</label>
                                <input type="text" class="form-control" name="port" placeholder="Port Service">
                      </div>
                      <div class="col-xs-4">
