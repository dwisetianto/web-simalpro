...
<head>
  ...
  <title>SIMALPRO | Integrated System</title>
                    ...
                    <div class="modal-body">       
                     <input type="hidden" name="kode" value="<?php echo $no_urut;?>"/> 
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="datel" class="form-control" value="<?php echo $datel;?>" id="inputUserName" placeholder="Datel">
                                        </div>
                                    </div>
                                  <div class="form-group">
    ...
    var table = $('#example1').DataTable({
        ...
        "drawCallback": function ( settings ) {
            ...
            api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                        '<tr class="group" style="background-color: #d73925; color: #fff; font-weight: bold;"><td colspan="8">'+group+'</td><td></td></tr>'
                    );
